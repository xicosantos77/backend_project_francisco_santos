...
<head>
    ...
    <title>TELLO - Reparações por Subcategorias</title>
</head>
<body>
...
?>          
    ...
    <main>
        <section class="products">
            <div class="container">
                <h3>Selecione a reparação do modelo que procura</h3>
                <div class="row">
<?php
                foreach($subcategories as $subcategory){
                    echo'
                        <div class="col-3 mx-auto">
                            <a href="/repairs_by_subcategory/'.$subcategory["product_cat_id"].'">
